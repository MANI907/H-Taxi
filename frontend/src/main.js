...
pluralCaseList.push( {plural: "grabs", pascal: "Grab"} )

pluralCaseList.push( {plural: "payments", pascal: "Payment"} )

pluralCaseList.push( {plural: "allocationManagements", pascal: "AllocationManagement"} )

pluralCaseList.push( {plural: "requestAllocationStatuses", pascal: "RequestAllocationStatus"} )
